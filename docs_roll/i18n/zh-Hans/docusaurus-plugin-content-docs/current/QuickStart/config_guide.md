...
有关 RLVR/Agentic Pipeline配置和Reward设置的更多详细信息，还可以参阅 [RLVR Pipeline Start](../UserGuide/pipeline/rlvr_pipeline_start.md) 和 [Agentic Pipeline Start](../UserGuide/pipeline/agentic_pipeline_start.md)
