...
配置系统描述参见[config_system](../../QuickStart/config_system.md)
#### 配置文件结构与组织
...
* 确保已安装所有必要依赖，建议从[镜像启动](../../QuickStart/installation.md)：
...
* **已训练模型** – 检查点保存在 `checkpoint_config`中，具体参考文档[checkpoint_and_resume](../../UserGuide/checkpoint_and_resume.md)。
